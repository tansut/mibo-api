...
export const UserSchema = new Schema({
    ...
    roles: [{ type: String, enum: [common.UserRoles.admin, common.UserRoles.dietitian, common.UserRoles.user, common.UserRoles.sales, common.UserRoles.therapist, common.UserRoles.trainer], default: [common.UserRoles.user] }],
